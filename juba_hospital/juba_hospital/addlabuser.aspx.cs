...
{
    public partial class addlabuser : System.Web.UI.Page
    {
        ...
        public static string deleteJob(string id)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(cs))
                {
                    ...
                    string jobQuery = "DELETE FROM [lab_user] WHERE [userid] = @id";
        ...
        public static string updateJob(string id, string name, string pass, string phone, string username)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(cs))
                {
                    ...
                    // Update jobs table
                    string jobQuery = "UPDATE [lab_user] SET " +
                          "[fullname] = @fullname," +
                            "[phone] = @phone," +
                               "[username] = @username," +
                           "[password] = @password" +
        ...
        public static string submitdata(string name, string pass, string phone, string username)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(cs))
                {
                    ...
                    string patientquery = "INSERT INTO lab_user (fullname, phone, username, password) VALUES (@name, @phone ,@username, @pass);";
