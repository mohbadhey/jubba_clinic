    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <button class="btn btn-success" onclick="showmedic()"> show medication report</button>
              <button class="btn btn-info" onclick="discharge()"> Discharge Patient</button>
...
<button id="print-button1" style="display: none;" onclick="printReport1()">Print Report</button>
  ...
  <script>
      ...
      function discharge() {
          ...
          var id = $("#pid").val();
          $.ajax({
              url: 'doctor_inpatient.aspx/submitdata',
              data: "{'id':'" + id + "'}",
              contentType: 'application/json; charset=utf-8',
              dataType: 'json',
              type: 'POST',
      ...
      $(document).ready(function () {
          ...
          $.ajax({
              url: 'doctor_inpatient.aspx/medic',
              ...
              success: function (response) {
                  ...
                  for (var i = 0; i < response.d.length; i++) {
                      ...
                      $("#datatable tbody").append(
                          ...
                          "<td><button class='edit-btn btn btn-success' data-id='" + response.d[i].prescid + "'>View Details</button></td>" +
                          "</tr>"
                      );
                  }
