<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="addxrayuser.aspx.cs" Inherits="juba_hospital.addxrayuser" %>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel1">Add image user </h5>
...
<div class="modal fade" id="medmodal1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel11">Update And Delete image user </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
<div class="modal-body">
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title"> Image User Section</h4>
                  </div>
                  <div class="card-body">
                    <div >
    ...
    <script>
        ...
        function update() {
            ...
            if (isValid) {
                ...
                $.ajax({
                    url: 'addxrayuser.aspx/updateJob',
        ...
        function deletejob() {
            ...
            $.ajax({
                type: "POST",
                url: "addxrayuser.aspx/deleteJob",
        ...
        function datadisplay() {
            $.ajax({
                url: 'addxrayuser.aspx/datadisplay',
                dataType: "json",
                type: 'POST',
                contentType: "application/json",
                success: function (response) {
        ...
        function submitInfo() {
            ...
            if (isValid) {
                ...
                $.ajax({
                    url: 'addxrayuser.aspx/submitdata',
