<%@ Page Title="" Language="C#" MasterPageFile="~/doctor.Master" AutoEventWireup="true" CodeBehind="pending_lap.aspx.cs" Inherits="juba_hospital.pending_lap" %>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Pending Lap Patients </h4>
                  </div>
                  <div class="card-body">
...
<script>
    ...
    $(document).ready(function () {
        ...
        var search = parseInt($("#label2").html());
            ...
            $.ajax({
                url: 'pending_lap.aspx/pendinglap',
                data: "{'search':'" + search + "'}",
                dataType: "json",
                type: 'POST',
